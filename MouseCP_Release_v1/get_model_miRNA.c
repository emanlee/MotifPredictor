...
int main(int argc, char *argv[]) 
{
	...
	char input_TF2miRNA[800]="mouseCP.TF2miRNA.txt";////// NO need this file 
	char input_TF2gene[800]="mouseCP.TF2gene.txt";   
	char input_miRNA2gene[800]="mouseCP.miRNA2TF.txt";  
	char input_miRNA2TF[800]="mouseCP.miRNA2gene.txt";

	char output_file[800]="mouseCP.miRNA_motif.txt";  
